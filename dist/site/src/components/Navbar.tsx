    ...
    <nav className="sticky top-0 z-50 w-full border-b border-slate-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80">
      <div className="mx-auto flex h-16 max-w-7xl items-center px-4 sm:px-6 lg:px-8">
        ...
        <div className="shrink-0">
          <a
            href="/"
            className="text-lg font-bold tracking-tight text-slate-900 transition-colors hover:text-indigo-600 sm:text-xl"
          >
            Acme
          </a>
        </div>
        ...
        <div className="ml-auto flex items-center gap-3 sm:gap-5">
          ...
          <div className="flex items-center gap-2 rounded-lg bg-slate-50 px-3 py-2">
            ...
            <span className="font-mono text-xs font-medium tabular-nums text-slate-700 sm:text-sm">
              {time}
            </span>
          </div>
